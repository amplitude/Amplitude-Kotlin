...
class ResponseHandlerIntegrationTest {
    ...
    @Test
    fun `test handle bad request response - missing field`() =
        runTest {
            amplitude = createFakeAmplitude(server)
