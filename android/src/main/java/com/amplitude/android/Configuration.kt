...
open class Configuration(
    ...
    open var useAdvertisingIdForDeviceId: Boolean = false,
    open var useAppSetIdForDeviceId: Boolean = false,
    open var newDeviceIdPerInstall: Boolean = false,
    open var trackingOptions: TrackingOptions = TrackingOptions(),
    open var enableCoppaControl: Boolean = false,
    open var locationListening: Boolean = false,
    open var flushEventsOnClose: Boolean = true,
    open var minTimeBetweenSessionsMillis: Long = MIN_TIME_BETWEEN_SESSIONS_MILLIS,
