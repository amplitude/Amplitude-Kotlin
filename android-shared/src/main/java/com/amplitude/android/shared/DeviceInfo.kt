...
class DeviceInfo(private val context: Context, locationListening: Boolean) {
    ...
    inner class CachedInfo {
        ...
        private fun fetchAppSetId(): String {
            try {
                ...
                AndroidLogger.logger
                    .w(TAG, "Google Play Services SDK not found for app set id!")
            } catch (e: InvocationTargetException) {
                AndroidLogger.logger.w(TAG, "Google Play Services not available for app set id")
            } catch (e: Exception) {
                AndroidLogger.logger.e(
                    TAG,
        ...
        private val fetchAndCacheGoogleAdvertisingId: String
            private get() {
                try {
                    ...
                    AndroidLogger.logger
                        .w(TAG, "Google Play Services SDK not found for advertising id!")
                } catch (e: InvocationTargetException) {
                    AndroidLogger.logger
                        .w(TAG, "Google Play Services not available for advertising id")
                } catch (e: Exception) {
                    AndroidLogger.logger.e(
                        TAG,
        ...
        private fun checkGPSEnabled(): Boolean {
            ...
            try {
                ...
                AndroidLogger.logger.w(TAG, "Google Play Services Util not found!")
            } catch (e: ClassNotFoundException) {
                AndroidLogger.logger.w(TAG, "Google Play Services Util not found!")
            } catch (e: NoSuchMethodException) {
                AndroidLogger.logger.w(TAG, "Google Play Services not available")
            } catch (e: InvocationTargetException) {
                AndroidLogger.logger.w(TAG, "Google Play Services not available")
            } catch (e: IllegalAccessException) {
                AndroidLogger.logger.w(TAG, "Google Play Services not available")
            } catch (e: Exception) {
                AndroidLogger.logger.w(
                    TAG,
        ...
        get() {
            ...
            for (provider in providers) {
                ...
                try {
                    ...
                    AndroidLogger.logger.w(TAG, "Failed to get most recent location")
                } catch (e: Exception) {
                    AndroidLogger.logger.w(TAG, "Failed to get most recent location")
                }
                if (location != null) {
    ...
    companion object {
        var TAG = DeviceInfo::class.java.name
