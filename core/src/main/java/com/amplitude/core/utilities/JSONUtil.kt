...
fun JSONObject.toBaseEvent(): BaseEvent {
    ...
    event.eventProperties =
        this.optionalJSONObject("event_properties", null)
            ?.toMapObj()
            ?.toMutableMap()
    event.userProperties =
        this.optionalJSONObject("user_properties", null)
            ?.toMapObj()
            ?.toMutableMap()
    event.groups =
        this.optionalJSONObject("groups", null)
            ?.toMapObj()
            ?.toMutableMap()
    event.groupProperties =
        this.optionalJSONObject("group_properties", null)
            ?.toMapObj()
            ?.toMutableMap()
