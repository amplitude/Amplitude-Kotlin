...
internal class DiagnosticsStorage(
    ...
    private fun persistSnapshot(snapshot: DiagnosticsSnapshot, directory: File) {
    ...
    private fun persistTags(tags: Map<String, String>, directory: File) {
        val json = JSONObject()
    ...
    private fun persistCounters(counters: Map<String, Long>, directory: File) {
        val json = JSONObject()
    ...
    private fun persistHistograms(histograms: Map<String, HistogramSnapshot>, directory: File) {
        val json = JSONObject()
    ...
    private fun persistEvents(events: List<DiagnosticsEvent>, directory: File) {
    ...
    private fun writeJsonToFile(
        ...
        try {
            ...
            logger.debug("DiagnosticsStorage: Persisted JSON: ${json.toString()} to file: ${file.absolutePath}")
        } catch (e: IOException) {
            tempFile.delete()
            throw e
        }
