...
class IdentifyInterceptTest {
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun `test multiple identify with set action only send one identify event`() = runTest(testDispatcher) {
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun `test multiple identify with set action only and one event`() = runTest(testDispatcher) {
        server.enqueue(MockResponse().setBody("{\"code\": \"success\"}"))
        amplitude.setUserId("user_id")
        advanceUntilIdle()
        amplitude.identify(Identify().set("key1", "key1-value1").set("key2", "key2-value1"))
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun `test multiple identify with set action only and one event and identify`() = runTest(testDispatcher) {
        server.enqueue(MockResponse().setBody("{\"code\": \"success\"}"))
        amplitude.setUserId("user_id")
        advanceUntilIdle()
        amplitude.identify(Identify().set("key1", "key1-value1").set("key2", "key2-value1"))
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun `test multiple identify with set action and clear all`() = runTest(testDispatcher) {
        server.enqueue(MockResponse().setBody("{\"code\": \"success\"}"))
        amplitude.setUserId("user_id")
        advanceUntilIdle()
        amplitude.identify(Identify().set("key1", "key1-value1").set("key2", "key2-value1"))
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun `test multiple identify with set action and another identify`() = runTest(testDispatcher) {
        server.enqueue(MockResponse().setBody("{\"code\": \"success\"}"))
        amplitude.setUserId("user_id")
        advanceUntilIdle()
        amplitude.identify(Identify().set("key1", "key1-value1").set("key2", "key2-value1"))
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun `test flush send intercepted identify`() = runTest(testDispatcher) {
        server.enqueue(MockResponse().setBody("{\"code\": \"success\"}"))
        amplitude.setUserId("user_id")
        advanceUntilIdle()
        amplitude.identify(Identify().set("key1", "key1-value1").set("key2", "key2-value1"))
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun `test multiple identify with set action only and set group and identify`() = runTest(testDispatcher) {
        server.enqueue(MockResponse().setBody("{\"code\": \"success\"}"))
        amplitude.setUserId("user_id")
        advanceUntilIdle()
        amplitude.identify(Identify().set("key1", "key1-value1").set("key2", "key2-value1"))
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun `test multiple identify with user id update`() = runTest(testDispatcher) {
        server.enqueue(MockResponse().setBody("{\"code\": \"success\"}"))
        amplitude.setUserId("user_id")
        advanceUntilIdle()
        amplitude.identify(Identify().set("key1", "key1-value1").set("key2", "key2-value1"))
