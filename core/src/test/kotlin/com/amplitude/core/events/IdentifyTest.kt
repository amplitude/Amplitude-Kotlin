...
class IdentifyTest {
    ...
    fun `test setOnce property`() {
        ...
        val identify =
            Identify().setOnce(property1, value1)
    ...
    fun `test preInsert property`() {
        ...
        val identify =
            Identify().preInsert(property1, value1)
    ...
    fun `test prepend property`() {
        ...
        val identify =
            Identify().prepend(property1, value1)
    ...
    fun `test remove property`() {
        ...
        val identify =
            Identify().remove(property1, value1)
